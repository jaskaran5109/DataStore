...
def OnSelected(event):
    ...
    lbl_title = Label(FormTitle, text="Add New Contact", font=('arial', 16), bg="#66ff66", width=400)
    lbl_title.pack()
...
Top = Frame(top, width=500, bd=1, relief=SOLID)
Top.pack(side=TOP)
lbl_title = Label(Top, text="Contact Management System", font=('arial', 16), width=700)
lbl_title.pack()

Mid = Frame(top, width=700, bg="#6666ff")
Mid.pack(side=TOP)

MidLeft = Frame(Mid, width=100)
MidLeft.pack(side=LEFT, pady=0)
